/** Smoke test Eventos (TASK-359). */
import { chromium } from 'playwright';
const BASE = process.env.SMOKE_BASE_URL || 'https://viralata.web.app';
const ROUTES = [
  { path: '/eventos' },
  { path: '/eventos/vitrines' },
  { path: '/eventos/comunidades' },
  { path: '/eventos/calendario' },
  { path: '/eventos/admin', expect: [302, 307, 200] },
  { path: '/eventos/participantes', expect: [302, 307, 200] },
];
