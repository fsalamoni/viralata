/** Smoke test Adotante (TASK-359). */
import { chromium } from 'playwright';
const BASE = process.env.SMOKE_BASE_URL || 'https://viralata.web.app';
const ROUTES = [
  { path: '/adotar' },
  { path: '/pets' },
  { path: '/pet/demo-pet-id', expect: [200, 404] },
  { path: '/meu-painel', expect: [302, 307, 200] },
  { path: '/minhas-applications', expect: [302, 307, 200] },
  { path: '/adocoes', expect: [302, 307, 200] },
  { path: '/pos-adocao', expect: [302, 307, 200] },
];
