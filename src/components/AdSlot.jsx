...
export default function AdSlot({ className = '' }) {
  ...
  return (
    <section className={`border-dashed border-border bg-secondary/40 ${className}`}>
      <div className="arena-section-card-body flex items-center gap-3 py-4 text-muted-foreground">
