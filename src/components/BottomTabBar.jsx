...
export default function BottomTabBar() {
  ...
  return (
    <nav
      ...
      className={cn(
        // V3 (TASK-V3-UI-6): BottomTabBar SÓ MOBILE. Em desktop a barra
        // inferior é o LegalFooter (termos e políticas). As 2 são fixas
        // quando "sempre visível" — mobile: nav, desktop: footer.
