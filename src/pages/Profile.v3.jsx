...
export default function PROFILEV3() {
  ...
  return (
    <div className="arena-page mx-auto max-w-7xl px-4 py-6" data-testid="profile-page">
      <Seo title="PROFILE — Viralata" description="V3 redesign de PROFILE no padrão DS-V2." />
      <h1 className="text-2xl font-extrabold text-foreground">PROFILE (V3 — em construção)</h1>
      <p className="mt-2 text-[14px] text-muted-foreground">
        Esta página está sendo refeita do zero no padrão V3.
        Flag <code>V3_PAGE_PROFILE</code> deve estar ON para visualizar.
      </p>
      <EmptyState
