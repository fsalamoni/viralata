/**
 * @fileoverview FOSTER V3 — redesign completo no padrão DS-V2.
 *
 * V3 (TASK-V3-FOSTER): implementação do zero, sem aproveitar o JSX do V1.
...
export default function FosterV3() {
  ...
  return (
    <div className="arena-page mx-auto max-w-7xl px-4 py-6" data-testid="foster-page">
      <Seo title="FOSTER — Viralata" description="V3 redesign de FOSTER no padrão DS-V2." />
      <h1 className="text-2xl font-extrabold text-foreground">FOSTER (V3 — em construção)</h1>
      <p className="mt-2 text-[14px] text-muted-foreground">
        Esta página está sendo refeita do zero no padrão V3.
        Flag <code>V3_PAGE_FOSTER</code> deve estar ON para visualizar.
      </p>
      <EmptyState
