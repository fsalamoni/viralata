...
describe('cleanupStaleCaches', () => {
  ...
  it('unregister SWs antigos (sw.js até sw-v74.js), preserva sw-v88.js', async () => {
    // Atualizado para v75 (2026-07-27) — preserva apenas sw-v88 (atual).
    const caches = makeCacheStorage([]);
    globalThis.caches = caches;
    const regs = [
      ...
      makeReg('https://viralata.web.app/sw-v88.js'),
    ];
    Object.defineProperty(globalThis.navigator, 'serviceWorker', {
