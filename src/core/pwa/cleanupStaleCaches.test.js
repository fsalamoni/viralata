...
describe('cleanupStaleCaches', () => {
  ...
  it('unregister SWs antigos (sw.js até sw-v67.js), preserva sw-v68.js', async () => {
    // Atualizado para v68 (2026-07-20) — preserva apenas sw-v68 (atual).
    const caches = makeCacheStorage([]);
    globalThis.caches = caches;
    const regs = [
      ...
      makeReg('https://viralata.web.app/sw-v68.js'),
    ];
    Object.defineProperty(globalThis.navigator, 'serviceWorker', {
