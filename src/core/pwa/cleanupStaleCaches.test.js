...
describe('cleanupStaleCaches', () => {
  ...
  it('unregister SWs antigos (sw.js até sw-v74.js), preserva sw-v85.js', async () => {
    // Atualizado para v75 (2026-07-27) — preserva apenas sw-v85 (atual).
    const caches = makeCacheStorage([]);
    globalThis.caches = caches;
    const regs = [
      ...
      makeReg('https://viralata.web.app/sw-v85.js'),
    ];
    Object.defineProperty(globalThis.navigator, 'serviceWorker', {
