...
### Q1. Quem é o público-alvo principal da página ADMIN?
...
- D1: decisão #1 do redesign V3 de ADMIN (a definir no step-2)
- D2: decisão #2 do redesign V3 de ADMIN (a definir no step-2)
- D3: decisão #3 do redesign V3 de ADMIN (a definir no step-2)
- D4: decisão #4 do redesign V3 de ADMIN (a definir no step-2)
- D5: decisão #5 do redesign V3 de ADMIN (a definir no step-2)
- D6: decisão #6 do redesign V3 de ADMIN (a definir no step-2)
- D7: decisão #7 do redesign V3 de ADMIN (a definir no step-2)
- D8: decisão #8 do redesign V3 de ADMIN (a definir no step-2)
- D9: decisão #9 do redesign V3 de ADMIN (a definir no step-2)
- D10: decisão #10 do redesign V3 de ADMIN (a definir no step-2)
- D11: decisão #11 do redesign V3 de ADMIN (a definir no step-2)
- D12: decisão #12 do redesign V3 de ADMIN (a definir no step-2)
