...
> **Status**: 🟡 EM CONSTRUÇÃO (TASK-TASK-V3-ADOPTION)
...
> **Atualizado em**: 2026-07-18T04:52:04.850Z
...
```
1. useFeatureFlag(V3_PAGE_ADOPTION) === true → <PageV3 /> (lazy)
2. Senão                       → <PageV1 />
```
...
- Análise inicial: `docs/V3_ADOPTION_QUESTIONS.md`
