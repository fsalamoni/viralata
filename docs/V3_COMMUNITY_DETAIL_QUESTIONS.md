# V3 COMMUNITY_DETAIL — Análise e Q&A

> Gerado por `.harness/v3-redesign/step-1-analyze.cjs`
> Task: `TASK-V3-COMMUNITY_DETAIL` | Flag: `V3_PAGE_COMMUNITY_DETAIL`
> Página V1: `src/modules/communities/pages/CommunityDetail.jsx` (288 linhas)
...
| Rota | / |
| Componente V1 | `src/modules/communities/pages/CommunityDetail.jsx` |
| Linhas V1 | 288 |
| Bytes V1 | 12608 |
| Imports V1 | 24 (react-router-dom, react-router-dom, lucide-react, @/core/lib/FirebaseAuthContext, @/core/lib/FeatureFlagsContext...) |
| Hooks V1 | 10 (State, Effect, SearchParams, Params, Auth, FeatureFlag, MyCommunityMembership, Communities, ArenaPageClasses, Memo) |
| Componentes V1 | 19 (CommunityCover, ClubCover, Skeleton, EmptyState, Button...) |
...
### Q1. Quem é o público-alvo principal da página COMMUNITY_DETAIL?
...
- D1: decisão #1 do redesign V3 de COMMUNITY_DETAIL (a definir no step-2)
- D2: decisão #2 do redesign V3 de COMMUNITY_DETAIL (a definir no step-2)
- D3: decisão #3 do redesign V3 de COMMUNITY_DETAIL (a definir no step-2)
- D4: decisão #4 do redesign V3 de COMMUNITY_DETAIL (a definir no step-2)
- D5: decisão #5 do redesign V3 de COMMUNITY_DETAIL (a definir no step-2)
- D6: decisão #6 do redesign V3 de COMMUNITY_DETAIL (a definir no step-2)
- D7: decisão #7 do redesign V3 de COMMUNITY_DETAIL (a definir no step-2)
- D8: decisão #8 do redesign V3 de COMMUNITY_DETAIL (a definir no step-2)
- D9: decisão #9 do redesign V3 de COMMUNITY_DETAIL (a definir no step-2)
- D10: decisão #10 do redesign V3 de COMMUNITY_DETAIL (a definir no step-2)
- D11: decisão #11 do redesign V3 de COMMUNITY_DETAIL (a definir no step-2)
- D12: decisão #12 do redesign V3 de COMMUNITY_DETAIL (a definir no step-2)
