...
> **Status**: 🟡 EM CONSTRUÇÃO (TASK-TASK-V3-MURAL)
...
> **Atualizado em**: 2026-07-18T05:50:47.382Z
...
```
1. useFeatureFlag(V3_PAGE_MURAL) === true → <PageV3 /> (lazy)
2. Senão                       → <PageV1 />
```
...
- Análise inicial: `docs/V3_MURAL_QUESTIONS.md`
