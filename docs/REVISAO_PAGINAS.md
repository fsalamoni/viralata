...
> Nota: redeploy disparado após instabilidade do GitHub Actions (2026-08-06; reenfileirado para publicar o gate admin-only do switch de abrigo; 2ª tentativa após a plataforma seguir instável).
