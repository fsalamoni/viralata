# V3 HOME — Análise e Q&A

> Gerado por `.harness/v3-redesign/step-1-analyze.cjs`
> Task: `TASK-V3-HOME` | Flag: `V3_PAGE_HOME`
> Página V1: `src/pages/Home.jsx` (252 linhas)
...
| KEY | HOME |
| Rota | / |
| Componente V1 | `src/pages/Home.jsx` |
| Linhas V1 | 252 |
| Bytes V1 | 13258 |
| Imports V1 | 11 (react, @/components/HomeStats, @/components/Seo, react-router-dom, framer-motion...) |
| Hooks V1 | 1 (PlatformSettings) |
| Componentes V1 | 10 (Seo, HomeStats, Icon, Button, Link...) |
...
### Q1. Quem é o público-alvo principal da página HOME?
...
- D1: decisão #1 do redesign V3 de HOME (a definir no step-2)
- D2: decisão #2 do redesign V3 de HOME (a definir no step-2)
- D3: decisão #3 do redesign V3 de HOME (a definir no step-2)
- D4: decisão #4 do redesign V3 de HOME (a definir no step-2)
- D5: decisão #5 do redesign V3 de HOME (a definir no step-2)
- D6: decisão #6 do redesign V3 de HOME (a definir no step-2)
- D7: decisão #7 do redesign V3 de HOME (a definir no step-2)
- D8: decisão #8 do redesign V3 de HOME (a definir no step-2)
- D9: decisão #9 do redesign V3 de HOME (a definir no step-2)
- D10: decisão #10 do redesign V3 de HOME (a definir no step-2)
- D11: decisão #11 do redesign V3 de HOME (a definir no step-2)
- D12: decisão #12 do redesign V3 de HOME (a definir no step-2)
