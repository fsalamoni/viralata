...
| 11 | Vitrines / Eventos | ✅ Concluída | #53 |
| 12 | Escalas + RSVP de Vitrines | ✅ Concluída | (ver `feat/shelter-exhibition-rsvps`) |
...
**13/22 fases concluídas.** Detalhes completos em `docs/SHELTER_MGMT_ROADMAP.md` e em `.mavis/scratchpad/shelter-roadmap-tracker.md`.
